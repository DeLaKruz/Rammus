...
void populate_fake_data(RepositoryManager *manager) {
    ...
    repository_add(manager, "Juegos Clásicos", "classic_games");
    ...
    repository_add(manager, "Documentación", "documentation");
    ...
    repository_add(manager, "Películas", "movies");
    ...
    repository_add(manager, "Música", "music");
